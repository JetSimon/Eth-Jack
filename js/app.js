...
Vue.component('dealer', {
    ...
    <div>
        ...
        Your Balance: {{userBalance}} ETH ({{userBalance * conversion}} CAD) <br><br>  
        ...
        <div class="flex px-10 py-3 rounded-full shadow-lg h-20 text-4xl font-bold text-gray-700"><p class="mt-1">{{balance}} ETH</p></div>
        <p class="-my-7 text-lg text-gray-300">(\${{balance * conversion}} CAD)</p>
        <div class="pt-1 -my-20 text-gray-700 italic tracking-wide">Dealer's Balance</div>

        <div class="-my-14">
        <p class="text-6xl font-bold tracking-wide pb-5 text-gray-700">make a bet</p>
        <div class="bg-gray-100 rounded-lg py-10 px-10 grid grid-cols-4 shadow mx-auto w-1/2">
